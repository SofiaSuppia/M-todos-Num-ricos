...
#define MAX_PUNTOS 20 // Máximo número de puntos
#define MAX_TAMANO 100 // Máximo tamaño para la matriz
...
// Nota: La función teórica ahora tiene un cuerpo definido: f(x) = x + 2/x
double evaluar_funcion(double x) {
    return x + (2.0/x);
}