...
Con estas soluciones, tenemos el polinomio:
    f(x) = -0.333x^3 + 1.5x^2 - 0.167x + 0.0x
...
Lo verificamos:
    ...
    f(2) = 3.0
    f(3) = 4.0
Como dice el enunciado del ejercicio, el polinomio pasa por los puntos (0,0), (1,1), (2,3) y (3,4).
*/
...
int main(int argc, char const *argv[]) {
    ...
    if(!leer_archivo_arreglo("C:\\Users\\Juan Carlos\\OneDrive\\Documentos\\M-todos-Num-ricos\\Guias\\Guia3\\Ejercicio3\\data.dat", a, b, &n)) {
        return 1;
    }
